...
const PersonalInfo = () => {
  return (
    <div className='ml-72 w-screen pl-9 p-0 bg-[#f9fafb]'>
      ...
      <form action="" className='gap-16 mb-36  flex flex-col w-[846px]'>

        <div className='flex gap-16 h-[450px] flex-wrap justify-stretch items-center'>
...
<div className='w-[800px] mt-16 h-1 bg-[#d9d9d9]'>
</div>
        ...
        <div className='flex gap-8 justify-center w-[471px] ml-52 px-0 items-center  my-8'>
