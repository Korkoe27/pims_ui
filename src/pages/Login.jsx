...
const Login = () => {
  return (
    <div className='flex flex-col justify-center items-center h-full my-10 bg-white w-full'>
      <Logo displayType='block' />
      <h1 className='font-bold mb-3'>Patient Information Management System</h1>
      <div className='flex flex-col items-center justify-evenly bg-white border border-[#D0D5DD] p-8 rounded-lg h-[470px] w-[400px] '>
        ...
        <div className='w-full'>
          ...
          <div className='flex border border-gray-300 rounded-lg w-full items-center px-3 py-2'>
            <PiUserCircle className='text-[##667185] h-[20px] w-[20px] mr-2' />
        ...
        <div className='w-full'>
          ...
          <div className='flex border border-gray-300 rounded-lg w-full items-center px-3 py-2'>
            <CiLock className='text-[##667185] mr-2 h-[20px] font-extrabold w-[20px]' />
        ...
        <button className='bg-[#2F3192] text-white px-4 rounded-lg h-[56px] transition duration-200 w-full'>Log into your account</button>
      </div>
    </div>
  );
}
